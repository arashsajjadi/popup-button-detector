...
│── 📂 output/                       # Output images with detected buttons
│   ├── output_N_test.jpg
│   ├── output_N_test_1.png
│   ├── output_N_test_2.png
│   ├── output_N_test_3.png
...
│   ├── test_2.png
│   ├── test_3.png
│── 📄 .gitignore                     # Ignored files (e.g., .pt models, temp files)
```
...
```python
orig_image, rgb_image = preprocess_image("test.jpg")
```
...
cv2.imwrite("output/output_N_test.jpg", output_image)
```
...
model.train(data='popups.yaml', epochs=50, batch=16, imgsz=640)
```
